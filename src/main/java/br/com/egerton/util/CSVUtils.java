...
public class CSVUtils {
    ...
    public static String gerar(RetornoSQL retorno) {
        return gerar(retorno, false, "", "");
    }

    public static String gerar(RetornoSQL retorno, boolean ignorarCabecalho) {
        return gerar(retorno, ignorarCabecalho, "", "");
    }

    public static String gerar(RetornoSQL retorno, String separador, String qualificador) {
        return gerar(retorno, false, separador, qualificador);
    }

    public static String gerar(RetornoSQL retorno, boolean ignorarCabecalho, String separador, String qualificador) {
        String csv = "";
